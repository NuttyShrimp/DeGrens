...
RegisterServerEvent('DGCore:DebugSomething', function(table, indent)
    local resource = GetInvokingResource() or "dg-core"
...
function DGCore.Debug(table, indent)
    TriggerEvent('DGCore:DebugSomething', table, indent)
end
