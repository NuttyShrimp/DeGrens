...
if Config.SqlKeybinding then
	...
	AddEventHandler('dp:ServerKeybindExist', function()
		...
		exports['dg-sql']:query("SELECT * FROM dpkeybinds WHERE `id`=@id;", { ['@id'] = srcid }, function(dpkeybinds)
	...
	AddEventHandler("dp:ServerKeybindGrab", function()
		...
		exports['dg-sql']:query("SELECT keybind1, emote1, keybind2, emote2, keybind3, emote3, keybind4, emote4, keybind5, emote5, keybind6, emote6 FROM `dpkeybinds` WHERE `id` = @id", { ['@id'] = srcid }, function(kb)
	...
	AddEventHandler("dp:ServerKeybindUpdate", function(key, emote)
		...
		if chosenk == "keybind1" then
			exports['dg-sql']:query("UPDATE dpkeybinds SET emote1=@emote WHERE id=@id", { id = myid, emote = emote }, function()
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote)
			end)
		elseif chosenk == "keybind2" then
			exports['dg-sql']:query("UPDATE dpkeybinds SET emote2=@emote WHERE id=@id", { id = myid, emote = emote }, function()
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote)
			end)
		elseif chosenk == "keybind3" then
			exports['dg-sql']:query("UPDATE dpkeybinds SET emote3=@emote WHERE id=@id", { id = myid, emote = emote }, function()
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote)
			end)
		elseif chosenk == "keybind4" then
			exports['dg-sql']:query("UPDATE dpkeybinds SET emote4=@emote WHERE id=@id", { id = myid, emote = emote }, function()
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote)
			end)
		elseif chosenk == "keybind5" then
			exports['dg-sql']:query("UPDATE dpkeybinds SET emote5=@emote WHERE id=@id", { id = myid, emote = emote }, function()
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote)
			end)
		elseif chosenk == "keybind6" then
			exports['dg-sql']:query("UPDATE dpkeybinds SET emote6=@emote WHERE id=@id", { id = myid, emote = emote }, function()
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote)
			end)
		end
	end)
