...
AddEventHandler('animations:client:EmoteCommandStart', function(args)
  if CanDoEmote then
    ...
    DGCore.Functions.Notify("Cannot Be Done Right Now", "error")
  end
end)
...
function EmoteCommandStart(source, args, raw)
    ...
    if name == "c" then
        if IsInAnimation then
          ...
          DGCore.Functions.Notify('No Emote To Cancel', 'error')
        end
      return
    ...
    elseif DP.PropEmotes[name] ~= nil then
      ...
      DGCore.Functions.Notify('That Is Not A Valid Command', 'error')
    end
  end
end
