...
onNet("screenshot_basic:requestImgurScreenshot", (options: any) => {
	const _data = { ...options };
	delete options.link;
	delete options.field;
	exp["screenshot-basic"].requestScreenshotUpload(_data.link, _data.field, options, (screenData: any) => {
		emitNet("screenshot-basic:incomingImgurScreenshot", _data, screenData);
	});
});
