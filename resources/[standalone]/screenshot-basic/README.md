...
### Uploading requesting and upload to imgur
#### JavaScript example
```javascript
// async
const link = await exports['screenshot-basic'].requestClientImgurScreenshot(plyServerId);
// sync
exports['screenshot-basic'].requestClientImgurScreenshot(plyServerId, (link) => {
...
```lua
-- async
local link = exports['screenshot-basic']:requestClientImgurScreenshot(plyServerId)
-- sync
exports['screenshot-basic']:requestClientImgurScreenshot(plyServerId, function(link)
    -- do something with link
end)
```
