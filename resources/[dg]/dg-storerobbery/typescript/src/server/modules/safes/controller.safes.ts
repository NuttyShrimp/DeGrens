...
Events.onNet('storerobbery:server:hackSafe', (src: number, storeId: Store.Id) => {
...
Events.onNet('storerobbery:server:lootSafe', (src: number, storeId: Store.Id) => {
  ...
  const specialItemChance = 50;
  if (Util.getRndInteger(0, 100) < specialItemChance) {
