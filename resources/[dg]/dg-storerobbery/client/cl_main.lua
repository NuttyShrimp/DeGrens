...
AddEventHandler('police:SetCopCount', function(amount) currentCops = amount end)
...
--         end
--     end
--     if (not true and math.random(1, 100) <= 25) then -- HANDSHOES
--         local pos = GetEntityCoords(PlayerPedId())
--         TriggerServerEvent("evidence:server:CreateFingerDrop", pos)
