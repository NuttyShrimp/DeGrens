...
exports["dg-lib"]:registerKeyMapping('switchPhoneCamera', 'Verander phone camera', '+switchPhoneCamera', '-switchPhoneCamera', 'UP', true)

exports["dg-lib"]:registerKeyMapping('takePhoneCameraPicture', 'Neem photo (phone)', '+takePhoneCameraPicture', '-takePhoneCameraPicture', 'RETURN', true)
