...
declare class ClientFunctions {
	 ...
	 */
	TriggerCallback<T = void>(name: string, cb?: Function, ...args: any[]): T;
	TriggerCallback<T = void>(name: string, ...args: any[]): Promise<T>;
...
declare interface ProgressbarProp {
	model?: string;
	bone?: string;
