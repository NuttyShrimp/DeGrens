...
DGCore.Functions.CreateCallback('qb-trunk:server:getTrunkBusy', function(source, cb, plate)
...
DGCore.Commands.Add("getintrunk", "Get In Trunk", {}, false, function(source, args)
    TriggerClientEvent('qb-trunk:client:GetIn', source)
end)

DGCore.Commands.Add("putintrunk", "Put Player In Trunk", {}, false, function(source, args)
