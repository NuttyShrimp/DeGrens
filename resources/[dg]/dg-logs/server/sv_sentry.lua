...
function GenerateUUID()
  return string.format("%07x%07x%07x%07x%04x", math.random(0, 0xfffffff), math.random(0, 0xfffffff),
    math.random(0, 0xfffffff), math.random(0, 0xfffffff), math.random(0, 0xffff))
end