...
import { deposit, paycheck, purchase, transfer, withdraw, mobile_transaction } from '../helpers/actions';
...
DGCore.Functions.CreateCallback('financials:server:action:mobileTransaction', async (src, cb, data: ActionData.Transfer) => {
	bankLogger.silly(
