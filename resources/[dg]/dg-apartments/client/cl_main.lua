...
RegisterNetEvent('dg-apartment:inviteMenu', function()
  local inviteListMenu = DGX.RPC.execute('dg-apartments:server:getApartmentInvites')
...
AddEventHandler('dg-apartment:openStash', function()
  local currentApartment = DGX.RPC.execute('dg-apartments:server:getCurrentApartment')
