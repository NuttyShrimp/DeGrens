    ...
    <q-dialog v-model="createDialog" persistent>
      <q-card style="min-width: 350px">
        ...
        <q-card-section class="q-pt-none">
          <q-input v-model="charInfo.firstname" dense label="Voornaam" autofocus />
          <q-input v-model="charInfo.lastname" dense label="Achternaam" autofocus />
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const today18 = `${today18Date.getFullYear()}/${
        today18Date.getMonth() + 1 < 10 ? '0' + (today18Date.getMonth() + 1) : today18Date.getMonth() + 1
      }/${today18Date.getDate()}`;
