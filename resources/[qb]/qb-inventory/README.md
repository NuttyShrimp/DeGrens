...
- [qb-logs](https://github.com/DGCore-framework/qb-logs) - For logging transfer and other history
- [qb-traphouse](https://github.com/DGCore-framework/qb-traphouse) - Trap house system for DGCore
- [qb-radio](https://github.com/DGCore-framework/qb-radio) - Radio system for communication
- [qb-drugs](https://github.com/DGCore-framework/qb-drugs) -  Drugs and weeds system
- [qb-shops](https://github.com/DGCore-framework/qb-shops) - Needed in order to add shops
