...
RegisterCommand('phone', function()
    ...
    if not PhoneData.isOpen and isLoggedIn then
        ...
        if not IsHandcuffed and not PlayerData.metadata['inlaststand'] and not PlayerData.metadata['isdead'] and not IsPauseMenuActive() then
            ...
            DGCore.Functions.Notify("Action not available at the moment..", "error")
        end
    end
end)
...
Citizen.CreateThread(function()
    while true do
        ...
        if isLoggedIn then
            DGCore.Functions.TriggerCallback('qb-phone:server:GetPhoneData', function(pData)   
...
function LoadPhone()
    ...
    DGCore.Functions.TriggerCallback('qb-phone:server:GetPhoneData', function(pData)
        ...
        PhoneData.PlayerData = DGCore.Functions.GetPlayerData()
...
RegisterNUICallback('HasPhone', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-phone:server:HasPhone', function(HasPhone)
        cb(HasPhone)
    end)
end)
...
function OpenPhone()
    DGCore.Functions.TriggerCallback('qb-phone:server:HasPhone', function(HasPhone)
        if HasPhone then
            ...
            DGCore.Functions.TriggerCallback('qb-phone:server:GetGarageVehicles', function(vehicles)
                PhoneData.GarageVehicles = vehicles
            end)
        else
            DGCore.Functions.Notify("You don't have a phone", "error")
        end
    end)
end
...
RegisterNUICallback('GetProfilePicture', function(data, cb)
    ...
    DGCore.Functions.TriggerCallback('qb-phone:server:GetPicture', function(picture)
        cb(picture)
    end, number)
end)
...
RegisterNUICallback('SendMessage', function(data, cb)
    ...
    DGCore.Functions.TriggerCallback('qb-phone:server:GetContactPicture', function(Chat)
        SendNUIMessage({
            action = "UpdateChat",
            chatData = Chat,
...
AddEventHandler('qb-phone:client:UpdateMessages', function(ChatMessages, SenderNumber, New)
	...
	table.insert(PhoneData.Chats, {
        ...
        if PhoneData.isOpen then
            ...
            Wait(100)
            DGCore.Functions.TriggerCallback('qb-phone:server:GetContactPictures', function(Chats)
                SendNUIMessage({
                    action = "UpdateChat",
...
RegisterNUICallback('PayInvoice', function(data, cb)
    ...
    DGCore.Functions.TriggerCallback('qb-phone:server:PayInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('DeclineInvoice', function(data, cb)
    ...
    DGCore.Functions.TriggerCallback('qb-phone:server:DeclineInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('CanTransferMoney', function(data, cb)
    ...
    if (PlayerData.money.bank - amount) >= 0 then
        DGCore.Functions.TriggerCallback('qb-phone:server:CanTransferMoney', function(Transferd)
            if Transferd then
...
RegisterNUICallback('CallContact', function(data, cb)
    ...
    DGCore.Functions.TriggerCallback('qb-phone:server:GetCallState', function(CanCall, IsOnline, contactData)
        local status = { 
            CanCall = CanCall, 
            IsOnline = IsOnline,
...
RegisterNUICallback('FetchSearchResults', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-phone:server:FetchResult', function(result)
        cb(result)
    end, data.input)
end)

RegisterNUICallback('FetchVehicleResults', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-phone:server:GetVehicleSearchResults', function(result)
        if result ~= nil then 
            for k, v in pairs(result) do
                DGCore.Functions.TriggerCallback('police:IsPlateFlagged', function(flagged)
...
RegisterNUICallback('FetchVehicleScan', function(data, cb)
    ...
    DGCore.Functions.TriggerCallback('qb-phone:server:ScanPlate', function(result)
        DGCore.Functions.TriggerCallback('police:IsPlateFlagged', function(flagged)
            result.isFlagged = flagged
	    if DGCore.Shared.Vehicles[vehname] ~= nil then
                result.label = DGCore.Shared.Vehicles[vehname]['name']
            else
...
RegisterNUICallback('SetAlertWaypoint', function(data)
    ...
    DGCore.Functions.Notify('GPS Location set: '..data.alert.title)
...
RegisterNUICallback('GetCryptoData', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-crypto:server:GetCryptoData', function(CryptoData)
        cb(CryptoData)
    end, data.crypto)
end)

RegisterNUICallback('BuyCrypto', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-crypto:server:BuyCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('SellCrypto', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-crypto:server:SellCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('TransferCrypto', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-crypto:server:TransferCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)
...
RegisterNUICallback('GetAvailableRaces', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-lapraces:server:GetRaces', function(Races)
        cb(Races)
    end)
end)
...
RegisterNUICallback('GetRaces', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-lapraces:server:GetListedRaces', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('GetTrackData', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-lapraces:server:GetTrackData', function(TrackData, CreatorData)
...
RegisterNUICallback('HasCreatedRace', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-lapraces:server:HasCreatedRace', function(HasCreated)
        cb(HasCreated)
    end)
end)
...
RegisterNUICallback('IsAuthorizedToCreateRaces', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-lapraces:server:IsAuthorizedToCreateRaces', function(IsAuthorized, NameAvailable)
        local data = {
...
RegisterNUICallback('GetRacingLeaderboards', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-lapraces:server:GetRacingLeaderboards', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('RaceDistanceCheck', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-lapraces:server:GetRacingData', function(RaceData)
        local ped = PlayerPedId()
        ...
        if dist <= 115.0 then
            ...
            DGCore.Functions.Notify('You\'re too far away from the race. GPS has been set to the race.', 'error', 5000)
...
RegisterNUICallback('CanRaceSetup', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-lapraces:server:CanRaceSetup', function(CanSetup)
        cb(CanSetup)
    end)
end)

RegisterNUICallback('GetPlayerHouses', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-phone:server:GetPlayerHouses', function(Houses)
        cb(Houses)
    end)
end)

RegisterNUICallback('GetPlayerKeys', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-phone:server:GetHouseKeys', function(Keys)
        cb(Keys)
    end)
end)
...
RegisterNUICallback('SetHouseLocation', function(data, cb)
    ...
    DGCore.Functions.Notify("GPS has been set to " .. data.HouseData.HouseData.adress .. "!", "success")
end)
...
RegisterNUICallback('TransferCid', function(data, cb)
    ...
    DGCore.Functions.TriggerCallback('qb-phone:server:TransferCid', function(CanTransfer)
        cb(CanTransfer)
    end, TransferedCid, data.HouseData)
end)

RegisterNUICallback('FetchPlayerHouses', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-phone:server:MeosGetPlayerHouses', function(result)
        cb(result)
    end, data.input)
end)
...
RegisterNUICallback('GetCurrentLawyers', function(data, cb)
    DGCore.Functions.TriggerCallback('qb-phone:server:GetCurrentLawyers', function(lawyers)
        cb(lawyers)
    end)
end)
...
RegisterNUICallback('GetTruckerData', function(data, cb)
    local TruckerMeta = DGCore.Functions.GetPlayerData().metadata["jobrep"]["trucker"]
