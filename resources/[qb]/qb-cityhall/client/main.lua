...
RegisterNUICallback('requestId', function(data)
    if inRange then
        ...
        DGCore.Functions.Notify('You have recived your '..idTypes[idType].label..' for $50', 'success', 3500)
    else
        DGCore.Functions.Notify('This will not work', 'error')
    end
end)
...
RegisterNUICallback('applyJob', function(data)
    if inRange then
        ...
        DGCore.Functions.Notify('Unfortunately will not work ...', 'error')
    end
end)
