        ...
        if WeaponChance ~= odd1 then
            if tier ~= 4 then
                 if Config.RewardTypes[itemType].type == "item" then
                     ...
                     TriggerClientEvent('inventory:client:ItemBox', src, DGCore.Shared.Items[item.item], "add")
                ...
                TriggerClientEvent('inventory:client:ItemBox', src, DGCore.Shared.Items['security_card_01'], "add")
            end
        else
            ply.Functions.AddItem('weapon_stungun', 1)
            TriggerClientEvent('inventory:client:ItemBox', src, DGCore.Shared.Items['weapon_stungun'], "add")
        end
    elseif type == "paleto" then
        ...
        if WeaponChance ~= odd1 then
            if tier ~= 4 then
                ...
                TriggerClientEvent('inventory:client:ItemBox', src, DGCore.Shared.Items['security_card_02'], "add")
            end
        else
            ply.Functions.AddItem('weapon_vintagepistol', 1)
            TriggerClientEvent('inventory:client:ItemBox', src, DGCore.Shared.Items['weapon_vintagepistol'], "add")
        end
    elseif type == "pacific" then
        ...
        if WeaponChance ~= odd1 or WeaponChance ~= odd2 then
            ...
            if chance == odd then
                ...
                TriggerClientEvent('inventory:client:ItemBox', src, DGCore.Shared.Items['weapon_microsmg'], "add")
            else
                ply.Functions.AddItem('weapon_minismg', 1)
                TriggerClientEvent('inventory:client:ItemBox', src, DGCore.Shared.Items['weapon_minismg'], "add")
            end
...
DGCore.Functions.CreateCallback('qb-bankrobbery:server:isRobberyActive', function(source, cb)
    cb(robberyBusy)
end)

DGCore.Functions.CreateCallback('qb-bankrobbery:server:GetConfig', function(source, cb)
    cb(Config)
end)
...
DGCore.Functions.CreateUseableItem("security_card_02", function(source, item)
    local Player = DGCore.Functions.GetPlayer(source)
...
DGCore.Functions.CreateUseableItem("electronickit", function(source, item)
    local Player = DGCore.Functions.GetPlayer(source)
