...
RegisterNetEvent("qb-garages:client:HouseGarage", function(house)
    DGCore.Functions.TriggerCallback("qb-garage:server:GetHouseVehicles", function(result)
        if result == nil then
            DGCore.Functions.Notify("You don't have any vehicles in your garage!", "error", 5000)
        else
...
RegisterNetEvent("qb-garages:client:DepotList", function()
    DGCore.Functions.TriggerCallback("qb-garage:server:GetDepotVehicles", function(result)
        if result == nil then
            DGCore.Functions.Notify("You don't have any impounded vehicles!", "error", 5000)
        else
...
RegisterNetEvent("qb-garages:client:VehicleList", function()
    DGCore.Functions.TriggerCallback("qb-garage:server:GetUserVehicles", function(result)
        if result == nil then
            DGCore.Functions.Notify("You don't have any vehicles in this garage!", "error", 5000)
        else
