...
AddEventHandler("consumables:client:UseJoint", function()
    DGCore.Functions.Progressbar("smoke_joint", "Lighting joint..", 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
    }, {}, {}, {}, function() -- Done
        TriggerEvent("inventory:client:ItemBox", exports["dg-inventory"]:GetItemData()["joint"], "remove")
...
AddEventHandler("consumables:client:UseParachute", function()
    EquipParachuteAnim()
    DGCore.Functions.Progressbar("use_parachute", "parachute using..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        TriggerEvent("inventory:client:ItemBox", exports["dg-inventory"]:GetItemData()["parachute"], "remove")
...
AddEventHandler("consumables:client:ResetParachute", function()
    if ParachuteEquiped then 
        EquipParachuteAnim()
        DGCore.Functions.Progressbar("reset_parachute", "Packing parachute..", 40000, false, true, {
            disableMovement = false,
            disableCarMovement = false,
            disableMouse = false,
            disableCombat = true,
            ...
            local ped = PlayerPedId()
            TriggerEvent("inventory:client:ItemBox", exports["dg-inventory"]:GetItemData()["parachute"], "add")
        ...
        DGCore.Functions.Notify("U dont have a parachute!", "error")
    end
end)
...
AddEventHandler("consumables:client:UseArmor", function()
    ...
    DGCore.Functions.Progressbar("use_armor", "Putting on the body armour..", 5000, false, true, {
        ...
        TriggerEvent("inventory:client:ItemBox", exports["dg-inventory"]:GetItemData()["armor"], "remove")
...
AddEventHandler("consumables:client:UseHeavyArmor", function()
    ...
    DGCore.Functions.Progressbar("use_heavyarmor", "Putting on body armour..", 5000, false, true, {
        ...
        TriggerEvent("inventory:client:ItemBox", exports["dg-inventory"]:GetItemData()["heavyarmor"], "remove")
...
AddEventHandler("consumables:client:ResetArmor", function()
    ...
    if currentVest ~= nil and currentVestTexture ~= nil then 
        DGCore.Functions.Progressbar("remove_armor", "Removing the body armour..", 2500, false, true, {
            ...
            SetPedArmour(ped, 0)
            TriggerEvent("inventory:client:ItemBox", exports["dg-inventory"]:GetItemData()["heavyarmor"], "add")
...
AddEventHandler("consumables:client:DrinkAlcohol", function(itemName)
    ...
    DGCore.Functions.Progressbar("snort_coke", "Drinking liquor..", math.random(3000, 6000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        TriggerEvent("inventory:client:ItemBox", exports["dg-inventory"]:GetItemData()[itemName], "remove")
...
AddEventHandler("consumables:client:Cokebaggy", function()
    local ped = PlayerPedId()
    DGCore.Functions.Progressbar("snort_coke", "Quick sniff..", math.random(5000, 8000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        TriggerEvent("inventory:client:ItemBox", exports["dg-inventory"]:GetItemData()["cokebaggy"], "remove")
...
AddEventHandler("consumables:client:Crackbaggy", function()
    local ped = PlayerPedId()
    DGCore.Functions.Progressbar("snort_coke", "Smoking crack..", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        TriggerEvent("inventory:client:ItemBox", exports["dg-inventory"]:GetItemData()["crack_baggy"], "remove")
...
AddEventHandler('consumables:client:EcstasyBaggy', function()
    DGCore.Functions.Progressbar("use_ecstasy", "Pops Pills", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        TriggerEvent("inventory:client:ItemBox", exports["dg-inventory"]:GetItemData()["xtcbaggy"], "remove")
        EcstasyEffect()
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "mp_suicide", "pill", 1.0)
...
AddEventHandler("consumables:client:Eat", function(itemName)
    ...
    DGCore.Functions.Progressbar("eat_something", "Eating..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
AddEventHandler("consumables:client:Drink", function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"drink"})
    DGCore.Functions.Progressbar("drink_something", "Drinking..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
