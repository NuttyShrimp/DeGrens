...
DGCore.Functions.CreateCallback('qb-hotdogjob:server:HasMoney', function(source, cb)
...
DGCore.Functions.CreateCallback('qb-hotdogjob:server:BringBack', function(source, cb)
    local Player = DGCore.Functions.GetPlayer(source)
