...
menu_button6:On("select", function()
    ...
    if result ~= nil and PlayerGang.name and PlayerGang.isboss then
        ...
        DGCore.Functions.Notify('Not High Enough Rank', "error")
    end
end)
...
menu_button:On("select", function()
    menu3:ClearItems()
    DGCore.Functions.TriggerCallback('qb-gangmenu:server:GetEmployees', function(cb)
...
function UpdateSociety()
    DGCore.Functions.TriggerCallback('qb-gangmenu:server:GetAccount', function(cb)
