...
if ActiveMission == 0 then
	...
	TriggerClientEvent('DGCore:Notify', _source, "You need $"..ActivationCost.." in the bank to accept the mission")
	else
...
AddEventHandler('AttackTransport:graczZrobilnapad', function(moneyCalc)
	...
	TriggerClientEvent('inventory:client:ItemBox', _source, DGCore.Shared.Items['markedbills'], "add")
	...
	TriggerClientEvent('inventory:client:ItemBox', _source, DGCore.Shared.Items['security_card_01'], "add")
	end
