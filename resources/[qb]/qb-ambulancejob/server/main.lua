...
RegisterNetEvent('hospital:server:TreatWounds', function(playerId)
	...
	if Patient then
		if Player.PlayerData.job.name =="ambulance" then
			...
			TriggerClientEvent('inventory:client:ItemBox', src, DGCore.Shared.Items['bandage'], "remove")
	...
	if Patient then
		if oldMan then
			if Player.Functions.RemoveMoney("cash", 5000, "revived-player") then
				...
				TriggerClientEvent('inventory:client:ItemBox', src, DGCore.Shared.Items['firstaid'], "remove")
