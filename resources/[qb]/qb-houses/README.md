# qb-houses
Real Estate for dg-core Framework :house_with_garden:
...
- [qb-radialmenu](https://github.com/DGCore-framework/qb-radialmenu) - For the menu in screenshots
- [qb-anticheat](https://github.com/DGCore-framework/qb-anticheat) - Anti Cheat 
- [qb-phone](https://github.com/DGCore-framework/qb-phone) - Houses app
- [qb-multicharacter](https://github.com/DGCore-framework/qb-multicharacter) - Checking if player is inside after character chosen (You need to edit the lines if you don't use this)
