...
AddEventHandler('qb-diving:client:NewLocations', function()
    DGCore.Functions.TriggerCallback('qb-diving:server:GetDivingConfig', function(Config, Area)
                            ...
                            if not CoralLocation.PickedUp then
                                ...
                                if CoralDistance <= 1.5 then
                                    ...
                                    if IsControlJustPressed(0, 38) then
                                        ...
                                        DGCore.Functions.Progressbar("take_coral", "Collecting coral", times * 1000, false, true, {
...
AddEventHandler('qb-diving:client:UseGear', function(bool)
    if bool then
        GearAnim()
        DGCore.Functions.Progressbar("equip_gear", "Put on a diving suit", 5000, false, true, {}, {}, {}, {}, function() -- Done
            DeleteGear()
        ...
        if currentGear.enabled then
            GearAnim()
            DGCore.Functions.Progressbar("remove_gear", "Pull out a diving suit ..", 5000, false, true, {}, {}, {}, {}, function() -- Done
                DeleteGear()
                ...
                ClearPedTasks(PlayerPedId())
                DGCore.Functions.Notify('You took your wetsuit off')
            end)
        else
            DGCore.Functions.Notify('You are not wearing a diving gear ..', 'error')
        end
    end
end)
