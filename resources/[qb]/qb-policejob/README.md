# qb-policejob
Police Job for dg-core Framework :police_officer:
...
- [qb-bossmenu](https://github.com/DGCore-framework/qb-bossmenu) - For the boss menu
- [qb-garages](https://github.com/DGCore-framework/qb-garages) - For the vehicle spawner
- [qb-clothing](https://github.com/DGCore-framework/qb-clothing) - For the locker room
- [qb-phone](https://github.com/DGCore-framework/qb-phone) - For the MEOS app and notifications etc.
- [qb-moneysafe](https://github.com/DGCore-framework/qb-moneysafe) - For the money safe
- [qb-log](https://github.com/DGCore-framework/qb-logs) - For logging certain events
