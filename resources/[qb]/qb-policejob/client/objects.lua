...
RegisterNetEvent('police:client:spawnCone', function()
    DGCore.Functions.Progressbar("spawn_object", "Place object..", 2500, false, true, {
...
RegisterNetEvent('police:client:deleteObject', function()
    ...
    if dist < 5.0 then
        DGCore.Functions.Progressbar("remove_object", "Removing object..", 2500, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,
...
RegisterNetEvent('police:client:SpawnSpikeStrip', function()
    if #SpawnedSpikes + 1 < SpikeConfig.MaxSpikes then
        ...
        DGCore.Functions.Notify('There are no Spikestrips left..', 'error')
    end
end)
