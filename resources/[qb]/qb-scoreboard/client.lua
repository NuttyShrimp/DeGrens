...
AddEventHandler('DGCore:Client:OnPlayerLoaded', function()
    isLoggedIn = true
    DGCore.Functions.TriggerCallback('qb-scoreboard:server:GetConfig', function(config)
...
RegisterCommand('scoreboard', function()
    if not scoreboardOpen then
        DGCore.Functions.TriggerCallback('qb-scoreboard:server:GetPlayersArrays', function(playerList)
            DGCore.Functions.TriggerCallback('qb-scoreboard:server:GetActivity', function(cops, ambulance)
                DGCore.Functions.TriggerCallback("qb-scoreboard:server:GetCurrentPlayers", function(Players)
