							...
							DrawText3Ds(-1928.81, 2059.53, 140.84, "[E] Start Picking Grapes") 
								...
								if IsControlJustReleased(0,38) then
									if PlayerJob.name == "vineyard" then
										...
										DGCore.Functions.Notify("I dont think I work here...", "error")
									end
								end
						end
					end
...
function pickProcess()
    DGCore.Functions.Progressbar("pick_grape", "Picking Grapes ..", math.random(6000,8000), false, true, {
...
function grapeJuiceProcess()
    DGCore.Functions.Progressbar("grape_juice", "Processing Grapes ..", math.random(15000,20000), false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
